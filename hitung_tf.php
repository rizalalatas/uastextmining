            ...
            <table border="1" align="center">
              <tr>
                <td colspan="5" bgcolor="#99CCFF">
                  <div align="center">wdt=tf*idf</div>
                </td>
                <td colspan="2" bgcolor="#CC99FF">
                  <div align="center">idf</div>
                </td>
              ...
              <tr>
                <!-- <td>
                  <div align="left">Aksi</div>
                </td> -->
                <td>
                  <div align="center">Term Keseluruhan</div>
                </td>
                <td>
...
//$df_q =$count_q/$count_q;
//$df_d1 =$count_d1/$count_d1 ;
//$df_d2 =$count_d2/$count_d2 ;
...
<tr>
	...
	<td><textarea rows=1 cols=2 name=q>$count_q</textarea></td>
	<td><textarea rows=1 cols=2 name=d1>$count_d1</textarea></td>
	<td><textarea rows=1 cols=2 name=d2>$count_d2</textarea></td>
	
	<td><textarea rows=1 cols=2 name=df>$df</textarea></td>
	
	<td><textarea rows=1 cols=7 name=idf>$idf</textarea></td>
	
	<td><textarea rows=1 cols=7 name=wdtq>$wdtq</textarea></td>
	<td><textarea rows=1 cols=7 name=wdt1>$wdt1</textarea></td>
	<td><textarea rows=1 cols=7 name=wdt2>$wdt2</textarea></td>
...
?>
    ...
    <p>&nbsp;</p>
    <div align="center" class="style2 style3">Copyright &copy;2019 Develoved by: Rijal Bani Salam S</div>
  </form>
</body>
